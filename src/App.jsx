...
/* AUTO IMPORT — exclude App.jsx and main.jsx */
...
export default function App() {
  ...
  return (
    // ✅ FIX 1: AuthContext.Provider wraps everything including HashRouter
    <AuthContext.Provider value={{ user, login, logout }}>
      {/* ✅ FIX 2: HashRouter is INSIDE the Provider, closed before Provider closes */}
      <HashRouter>
        <style>{`
          *{
            margin:0;
          ...
          @media(max-width:768px){
            ...
            .dashboard-card { aspect-ratio: auto; min-height: auto; padding: 20px; }
          }
          ...
          @media (max-height: 600px) and (orientation: landscape) {
            .app { min-height: auto; }
            .content { max-height: calc(100vh - 56px); padding: 8px; }
          }
        `}</style>
      ...
      {/* ✅ FIX 3: HashRouter closes HERE, then AuthContext.Provider closes below */}
